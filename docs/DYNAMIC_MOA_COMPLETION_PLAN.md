...
- Policy:
  ...
  - Planner/Reeviewer usage in same specialist runtime must be aggregated at request-level.
- Routing:
...
- This version is immutable for current edits unless a new epoch is created:
  - `DYNAMIC_MOA_COMPLETION_PLAN.md.sha256 = ac853067513253015c5e37529b040050164fbea9c06e616b1e7a548550dd581c`
