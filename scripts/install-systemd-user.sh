...
systemctl --user disable --now dgx-moa-loopback.socket dgx-moa-lan.socket \
  dgx-moa-loopback.service dgx-moa-lan.service 2>/dev/null || true
rm -f "$HOME/.config/systemd/user/dgx-moa-loopback.socket" \
  "$HOME/.config/systemd/user/dgx-moa-loopback.service" \
  "$HOME/.config/systemd/user/dgx-moa-lan.socket" \
  "$HOME/.config/systemd/user/dgx-moa-lan.service"
