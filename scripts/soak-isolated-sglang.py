...
RUNTIME_SCRIPT = ROOT / "scripts" / "validate-isolated-sglang-runtime.py"
SPEC = importlib.util.spec_from_file_location("isolated_sglang_runtime", RUNTIME_SCRIPT)
...
def request_one(
    ...
    payload: dict[str, Any] = {
        ...
        "temperature": 0,
        "max_tokens": 128 if role == "specialist" else 32,
    }
    if role == "specialist":
        payload.update(
...
def main() -> int:
    ...
    run.add_argument("--interval-seconds", type=positive_float, default=60)
